...
'{}', 
'{"features": ["Solar Powered – Built-in solar panel provides sustainable, off-grid power", "4K Ultra HD – Captures ultra-sharp video for precise detail", "PTZ Functionality – 355° pan & 90° tilt ensures complete area coverage", "Smart Night Vision – Switches between infrared and full-color night mode", "Dual-Band WiFi + 5G Support – Fast, stable connections", "Two-Way Audio – Talk and listen directly from your mobile device", "Motion Detection & Alerts – Sends instant notifications on movement", "Weatherproof Design – Built for tough outdoor environments"]}'),
...
'{}', 
'{"features": ["5 MP CMOS sensor offering sharp 4K/Full‑HD video quality", "355° horizontal sweep and 90° vertical tilt, controllable via app", "Smart Night Vision: 8-array LEDs up to 15–30 m", "Waterproof & Durable: IP65/IP66 construction", "Two-Way Audio: Built-in microphone and speaker", "Motion Detection & Alerts: Push/email notifications", "Flexible Storage: Supports micro‑SD up to 128 GB", "App Support: Compatible with CareCam Pro on iOS/Android"]}'),
...
'{}', 
'{"features": ["High-Capacity Battery: 84,000mAh (296Wh) lithium iron phosphate battery", "Pure Sine Wave Inverter (300W): Clean AC output (220V/50Hz)", "Multiple Output Options: 2× USB, 1× QC3.0, 5× 12V DC, 1× AC outlet", "Solar Panel Included: 2× 30W solar panels with 5m cable", "Smart LCD Display: Battery status and charging information", "Built-In Protection: Over-voltage, under-voltage, short-circuit protection", "Complete Kit: Power station, panels, cables, 4 bulbs, setup guide", "Ideal For: Camping, load-shedding, outdoor activities, emergency use"]}'),
...
'{}', 
'{"features": ["4K Ultra HD Imaging – Crystal-clear video capture", "Solar-Powered & 4G Connectivity – Off-grid operation with 4G SIM support", "PTZ Control – Motorised pan (355°) and tilt (90°) with AI auto-tracking", "Smart Motion Alerts – Human-body detection with instant notifications", "Night Vision & Two-Way Audio – IR-cut switching with built-in communication", "Waterproof Build (IP65) – Weather-resistant outdoor performance", "Flexible Storage – Micro-SD up to 128 GB, V380 app compatibility", "Compact Design – 2.5 kg weight with robust solar panel bracket"]}');
