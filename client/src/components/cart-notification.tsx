        ...
        <div className="p-6">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-shrink-0">
              <div className="w-20 h-20 rounded-xl overflow-hidden shadow-lg ring-2 ring-white/20 bg-white">
                {productImage ? (
                  <img
                    src={productImage}
                    alt={productName}
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-[#e0f2f1] to-[#b2dfdb] flex items-center justify-center">
